...
const gainlosspercent = chartData.map(row => Number(row.gainlosspercent));

const canvas1 = document.getElementById("myChart1");
const ctx1 = canvas1.getContext("2d");

/* Purchase gradient */
const purchaseGradient = ctx1.createLinearGradient(0,0,0,310);
purchaseGradient.addColorStop(0,"rgba(33,150,243,.30)");
purchaseGradient.addColorStop(1,"rgba(33,150,243,.01)");

/* Current gradient */
const currentGradient = ctx1.createLinearGradient(0,0,0,310);
